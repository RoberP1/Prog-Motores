...
namespace StarterAssets
{
	...
	public class ThirdPersonController : MonoBehaviour
	{
		...
		private void Update()
		{
			...
			{
				_animator.SetBool(_animIDAttackArma, true);
				IsAttacking = true;
			}
		}
		...
		IEnumerator DelayGirar(float delay)
		{
			stop = false;
		...
		private void AssignAnimationIDs()
		{
			...
			_animIDAttackArma = Animator.StringToHash("attackarma");
		}
